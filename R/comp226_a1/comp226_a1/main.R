...
# 调用 book.extra1() 函数，并提取期望值
expected_value1 <- book.extra1(book, 5)
expected_value2 <- book.extra2(book, 5)
expected_value3 <- book.extra3(book)
expected_value4 <- book.extra4(book, 0.1)

# 打印期望值
print(paste("Extra1期望值是：", expected_value1))
print(paste("Extra2期望值是：", expected_value2))
print(paste("Extra3期望值是：", expected_value3))
print(paste("Extra4期望值是：", expected_value4))